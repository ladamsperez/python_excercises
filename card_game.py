...
# - in that deck, put 2 - A of each suit ♥️ ♠️ ♣️ ♦️
#'J', 'Q', 'K', 'A'
...
def turn(player1, player2):
    # TODO abstract the player putting down a card into its own fucntion
    card1 = player1.pop()
    table.append(card1)
...
#  deal out 3 cards each the one more face up, compare again
...
# play stops when one player runs of cards, other player wins
